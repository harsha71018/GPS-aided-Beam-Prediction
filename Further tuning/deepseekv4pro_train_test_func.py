...
- Normalization (currently min-max only; norm_type reserved for future use)
"""
...
def normalize_pos(pos1, pos2, norm_type=1):
    """
    Currently only min-max normalization on pos2.
    norm_type parameter reserved for future extensions (e.g., z-score).
    """
    return min_max(pos2)